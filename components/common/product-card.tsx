...
function ProductCard({ name, price, thumbnail_image, description }: IProduct) {
  return (
    <div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
        <a href="" className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
        <div className="relative pb-48 overflow-hidden">
          <img className="absolute inset-0 h-full w-full object-cover" src={thumbnail_image} alt="" />
        </div>
        <div className="p-4">
          ...
          <div className="mt-3 flex items-center">
            <span className="text-sm font-semibold">${ price }</span>&nbsp;<span className="text-sm font-semibold"></span>
          </div>
        </div>
